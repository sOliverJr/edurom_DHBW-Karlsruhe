...
Config.instname = "Duale Hochschule Baden-Wuerttemberg Karlsruhe / " \
    "DHBW Karlsruhe"
Config.profilename = "eduroam"
Config.url = "your local eduroam® support page"
Config.email = "netz@dhbw-karlsruhe.de"
Config.title = "eduroam CAT"
Config.server_match = "dh-karlsruhe.de"
...
Config.user_realm = "dh-karlsruhe.de"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:aragorn.dh-karlsruhe.de', 'DNS:bilbo.dh-karlsruhe.de', 'DNS:freeradius.dh-karlsruhe.de', 'DNS:freeradius2.dh-karlsruhe.de']
